...
const addArticle = (article, done) => {
    ...
    const sql = "INSERT INTO articles (title, author, article_text, date_published, date_edited, created_by) VALUES (?,?,?,?,?,?)"; ;
    let values = [article.title, article.author, article.article_text, date, date,  1];
